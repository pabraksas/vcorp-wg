...
/** @type {import('workgroup').Config} */
const config = {
  name: "vCorp working group example",
  repoUrl: 'https://github.com/vcorp/wg-example',
  videoConferenceDetails: `https://zoom.us/j/593263740- _Password:_ vcorpwg`,
...
| :--------------- | :------------ | :----------------- | :-------------------- |
| Firstname Lastname (Host) | @ownername     | vCorp Foundation | San Francisco, CA, US |
`,
  ...
  description: `\
The Working Group meets regularly to discuss changes to the
[vCorp Specification][] and other core projects. This is an open
meeting in which anyone in the community may attend.

This is the primary monthly meeting, which typically meets on the first Thursday
of the month. In the case we have additional agenda items or follow ups, we also
hold additional secondary meetings later in the month.`,
  links: {
    "vcorp specification": "https://github.com/vcorp/vcorp-spec",
